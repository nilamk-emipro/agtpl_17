...
class ProductStructureEpt(models.Model):
    """
    Created one model product.structure.ept to modify some functionality like adding necessary
    fields.
    - Functionality
    ...
    """
    _name = 'product.structure.ept'
    _description = 'Structure for product.'
